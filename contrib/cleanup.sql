...
DELETE FROM phpbb_bb_players WHERE game_id = 'lineage2';
...
DELETE FROM phpbb_ext WHERE ext_name = 'avathar/bbguildlineage2';

-- ----------------------------------------------------------------------------
-- 3. phpBB migration tracking
-- ----------------------------------------------------------------------------

DELETE FROM phpbb_migrations WHERE migration_name LIKE '%avathar\\\\bbguildlineage2%';
